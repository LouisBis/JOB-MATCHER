...
Scoring runs entirely on-device via Ollama. No offer data or CV content is sent to an external API. Mistral 7B is a good balance between speed and reasoning quality for this task on CPU (~45s per offer).
